...
class TestNormalization(unittest.TestCase):
    ...
    def test_self_attention_normalization(self):
        ...
        # Without norm
        config1 = {"type": "SelfAttention", "emb_dim": self.emb_dim, "use_q_norm": False, "use_k_norm": False}
        block1 = BlockFactory.create(config1)
        out1 = block1(x)

        # With norm
        config2 = {"type": "SelfAttention", "emb_dim": self.emb_dim, "use_q_norm": True, "use_k_norm": True}
