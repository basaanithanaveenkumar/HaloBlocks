...
@BlockRegistry.register("multi_query_attention")
class MultiQueryAttention(Block):
    ...
    def forward(self, query, key=None, value=None, causal_mask=None, **kwargs):
        """
        Computes the Multi-Query Attention output.
        ...
        Args:
            ...
            causal_mask (torch.Tensor, optional): Optional boolean mask where 0 indicates positions to block.
            **kwargs: Ignored.
        ...
        if causal_mask is not None:
            # causal_mask could be (tgt_len, src_len) or (batch, 1, tgt_len, src_len)
