...
@BlockRegistry.register("grouped_query_attention")
class GroupedQueryAttention(Block):
    ...
    def forward(self, x, context=None, causal_mask=None, **kwargs):
        """
        ...
        Args:
            ...
            causal_mask (torch.Tensor, optional): Optional boolean mask.
            **kwargs: Ignored.
        ...
        if causal_mask is not None:
            # Assuming causal_mask is a byte/bool mask where 0 is ignore
